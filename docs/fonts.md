...
Node labels use scale 2. Fallback node glyphs use scale 2 or 3 according to
the marker size. Text is measured and rasterized at its final physical size,
then composed without stretching.
